...
const ProductGrid = () => {
  ...
  useEffect(() => {
    // Recupera los valores mínimos y máximos de los atributos de datos
    const minPrice = parseInt(rangeSliderRef.current.getAttribute('data-min'), 10);
    const maxPrice = parseInt(rangeSliderRef.current.getAttribute('data-max'), 10);

    $(rangeSliderRef.current).slider({
      range: true,
      min: minPrice,
      max: maxPrice,
      values: [minPrice, maxPrice],
      slide: function (event, ui) {
        $(minAmountRef.current).val('$' + ui.values[0]);
        $(maxAmountRef.current).val('$' + ui.values[1]);
      },
    });

    // Establece los valores iniciales en los campos de texto
    $(minAmountRef.current).val('$' + minPrice);
    $(maxAmountRef.current).val('$' + maxPrice);

    // Limpia los event listeners al desmontar el componente
    return () => {
      $(rangeSliderRef.current).slider('destroy');
    };
  }, []);
  return (
    <>
          ...
          <div class="card-body">
            <div class="row">
              <div class="mb-4 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    <div class="position-relative rounded-top overflow-hidden"><a class="d-block" href="../../../app/e-commerce/product/product-details.html"><img class="img-fluid rounded-top" src="./assets/img/products/2.jpg" alt="" /></a><span class="badge rounded-pill bg-success position-absolute mt-2 me-2 z-2 top-0 end-0">New</span>
                    </div>
                    <div class="p-3">
              ...
              <div class="mb-4 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    ...
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Apple MacBook Pro (15&quot; Retina, Touch Bar, 2.2GHz 6-Core Intel Core i7, 16GB RAM, 256GB SSD) - Space Gray (Latest Model)</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Computer &amp; Accessories</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $7199
                      </h5>
                      <p class="fs-10 mb-1">Shipping Cost: <strong>$65</strong></p>
                      <p class="fs-10 mb-1">Stock: <strong class="text-danger">Sold-Out</strong>
                      </p>
                    </div>
                  </div>
                  <div class="d-flex flex-between-center px-3">
                ...
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    ...
                    <div class="p-3">
                      ...
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $562.5
              ...
              <div class="mb-4 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    ...
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Apple iPhone XS Max (4GB RAM, 512GB ROM, 12MP Main Camera)</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Mobile &amp; Tabs</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $1050
                      </h5>
                      <p class="fs-10 mb-1">Shipping Cost: <strong>$65</strong></p>
                      <p class="fs-10 mb-1">Stock: <strong class="text-success">Available</strong>
                      </p>
              ...
              <div class="mb-4 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    <div class="position-relative rounded-top overflow-hidden"><a class="d-block" href="../../../app/e-commerce/product/product-details.html"><img class="img-fluid rounded-top" src="../../../assets/img/products/8.jpg" alt="" /></a><span class="badge rounded-pill bg-success position-absolute mt-2 me-2 z-2 top-0 end-0">New</span>
                    </div>
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Canon Standard Zoom Lens</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Camera</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $400
                        <del class="ms-2 fs-10 text-500">$500 </del>
                      </h5>
              ...
              <div class="mb-4 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    <div class="position-relative rounded-top overflow-hidden"><a class="d-block" href="../../../app/e-commerce/product/product-details.html"><img class="img-fluid rounded-top" src="../../../assets/img/products/6.jpg" alt="" /></a><span class="badge rounded-pill bg-success position-absolute mt-2 me-2 z-2 top-0 end-0">New</span>
                    </div>
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Logitech G305 Gaming Mouse</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Computer &amp; Accessories</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $95
                      </h5>
              ...
              <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    ...
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Nikon D3200 Digital DSLR Camera</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Camera</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $2398
                      </h5>
              ...
              <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    <div class="position-relative rounded-top overflow-hidden"><a class="d-block" href="../../../app/e-commerce/product/product-details.html"><img class="img-fluid rounded-top" src="../../../assets/img/products/5.jpg" alt="" /></a><span class="badge rounded-pill bg-success position-absolute mt-2 me-2 z-2 top-0 end-0">New</span>
                    </div>
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Apple Watch Series 4 44mm GPS Only</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Watches &amp; Accessories</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $360
                        <del class="ms-2 fs-10 text-500">$400 </del>
                      </h5>
              ...
              <div class="col-md-6 col-lg-4">
                <div class="border rounded-1 h-100 d-flex flex-column justify-content-between pb-3">
                  <div class="overflow-hidden">
                    ...
                    <div class="p-3">
                      <h5 class="fs-9"><a class="text-1100" href="../../../app/e-commerce/product/product-details.html">Nikon AF-S FX NIKKOR 24-70mm</a></h5>
                      <p class="fs-10 mb-3"><a class="text-500" href="#!">Camera</a></p>
                      <h5 class="fs-md-7 text-warning mb-0 d-flex align-items-center mb-3"> $956.57
                      </h5>
                      <p class="fs-10 mb-1">Shipping Cost: <strong>$50</strong></p>
                      <p class="fs-10 mb-1">Stock: <strong class="text-success">Available</strong>
                      </p>
